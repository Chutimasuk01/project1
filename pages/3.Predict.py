...
Gender = st.number_input("กรุณากรอกข้อมูล Gender")
Married = st.number_input("กรุณากรอกข้อมูล Married")
Dependents = st.number_input("กรุณากรอกข้อมูล Dependents")
Education = st.number_input("กรุณากรอกข้อมูล Education")
Self_Employed = st.number_input("กรุณากรอกข้อมูล Self_Employed")
ApplicantIncome = st.number_input("กรุณากรอกข้อมูล ApplicantIncome")
CoapplicantIncome = st.number_input("กรุณากรอกข้อมูล CoapplicantIncome")
LoanAmount = st.number_input("กรุณากรอกข้อมูล LoanAmount")
Loan_Amount_Term = st.number_input("กรุณากรอกข้อมูล Loan_Amount_Term")
